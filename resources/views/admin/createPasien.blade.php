        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="mb-4 rounded border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900">
                    Phase 1 clinical form uses FHIR Patient only. Legacy fields (age/height/weight/role/password) are hidden.
                </div>
                ...
                <form method="POST" action="{{ route('pasiens.store') }}" data-enhanced-form>
                    ...
                    <div class="flex items-center justify-end mt-6">
                        <x-primary-button data-submit-button>
                            <span data-submit-default>{{ __('Create Patient') }}</span>
                            <span data-submit-loading class="hidden">Creating Patient...</span>
                        </x-primary-button>
                    </div>
                </form>
            </div>
