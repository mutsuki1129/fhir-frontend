        ...
        <div class="flex justify-between items-center">
            ...
            <form action="{{ route('pasiens.list') }}" method="get" class="w-1/2 inline-block" data-page-loading-trigger>
                ...
                <div class="relative">
                    ...
                    <input type="search" name="query" id="default-search" value="{{ $query }}" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search name, email, phone">
